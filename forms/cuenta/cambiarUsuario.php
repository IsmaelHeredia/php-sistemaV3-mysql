...
<div class="card contenedor">
  ...
  <div class="card-body">
    <form method="POST" action="forms/cuenta/datos.php">
      ...
      <div class="mb-3">
        <label for="txtNuevoUsuario" class="form-label">Nuevo usuario</label>
        <input type="text" class="form-control" id="txtNuevoUsuario" name="txtNuevoUsuario" required />
      </div>
      <div class="mb-3">
      ...
      <div class="mt-5 text-center">
        <p class="lead">
          <button type="submit" id="cambiarUsuario" name="cambiarUsuario" class="btn btn-primary">Guardar</button>
